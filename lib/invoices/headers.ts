// Matches Power BI "Club Colors" UPS 250-column layout (UPS_Header_List in Power Query).
export const INVOICE_HEADERS = [
  ...
  'EORI Number',
  'Detail Keyed Dim',
  'Detail Keyed Unit of Measure',
  'Detail Keyed Billed Dimension',
  'Detail Keyed Billed Unit of Measure',
  'Original Service Description',
  'Promo Discount Applied Indicator',
  'Promo Discount Alias',
  'Place Holder 42',
  'Place Holder 43',
  'Place Holder 44',
  'Place Holder 45',
